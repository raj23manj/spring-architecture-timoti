...
public class BffDesktopPredicateFactory extends AbstractRoutePredicateFactory<BffDesktopPredicateFactory.Config> {
	...
	public BffDesktopPredicateFactory() {
		super(Config.class);
	}
	...
	public Predicate<ServerWebExchange> apply(Config config) {
		return exchange -> {
			...
			return "/bff".equalsIgnoreCase(requestPath) && StringUtils.equalsAnyIgnoreCase(deviceClass, "desktop");
		};
	}
}
